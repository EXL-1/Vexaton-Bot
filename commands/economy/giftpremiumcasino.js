...
module.exports = { 
    config: {
        name: "giftpremiumcasino",
        description: "Gives a user the Premium-Casino ticket!",
        usage: "<userID>",
        category: "economy",
        accessableby: "Owners"
    },
    ...
    let mcRole = message.guild.roles.find('name', "Premium-Casino");
    if(!mcRole) return;
    ...
    message.channel.send({embed: {
        color: 8117429,
        description: `Successfully gifted a Premium-Casino ticket to the User ID of **<@${mcRole.id}>**!.`,
        author: {
            name: message.author.tag,
            icon_url: message.author.displayAvatarURL
        ...
        sChannel.send({embed: {
            color: 8117429,
            description: `Gifted a Premium-Casino ticket to the User ID of **<@${mcRole.id}>**`,
            author: {
                name: message.author.tag,
                icon_url: message.author.displayAvatarURL
            }}});
